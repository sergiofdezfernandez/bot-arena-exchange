...
class TournamentManager:
    ...
    def _update_position(self, account: TraderAccount, symbol: str, trade_qty: int, price: int) -> Optional[dict]:
        """
    ...
    def process_trades(self, trades: List[Dict[str, object]]) -> List[dict]:
        """
        ...
        for trade in trades:
            ...
            ev_buy = self._update_position(buyer, symbol, qty, price)
            if ev_buy: 
                events.append(ev_buy)

            # Update seller inventory
            ev_sell = self._update_position(seller, symbol, -qty, price)
            if ev_sell: 
